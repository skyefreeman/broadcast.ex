defmodule Bluesky.FacetTest do
  ...
  describe "links/1" do
    ...
    test "excludes trailing punctuation from links" do
      ...
      assert String.slice(text, example_start, example_end - example_start) ==
               "https://example.com"
    end
  end
  ...
  describe "hashtags/1" do
    ...
    test "captures hashtags until the first non-alphanumeric character" do
      ...
      # "#elixir" is 7 bytes
      assert get_in(elixir_facet, ["index", "byteEnd"]) -
               get_in(elixir_facet, ["index", "byteStart"]) == 7
    end
